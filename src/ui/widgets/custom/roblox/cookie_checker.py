...
class _BoundSwitchRow(MTWidget):
    ...
    def __init__(
        ...
        *,
        ...
        self._switch.setChecked(bool(config.get(self._cfg_key, default=self._default)))
    ...
    def reload_from_config(self) -> None:
        self.set_checked(bool(config.get(self._cfg_key, default=self._default)))
...
class _SortActionButton(MTButton):
    ...
    def __init__(
        ...
        *,
        ...
        self.setProperty('rainbowCheckedTextIconTarget', True)
...
class _SortListEntryRow(MTWidget):
    ...
    def __init__(
        ...
        *,
        ...
        self._remove_button.setProperty("rainbowBorderTarget", False)
...
class _SortListEditor(MTWidget):
    ...
    def _save_entries(self) -> None:
        ...
        config.set(self._cfg_key_items, items)
        self.changed.emit()
...
class _CookieCheckerSortPopup(MTPopup):
    ...
    def __init__(
        ...
        *,
        ...
        self._close_button.setProperty("rainbowBorderTarget", False)
        self._close_button.setProperty("rainbowBorderExcluded", True)
    ...
    def reload_from_config(self) -> None:
        ...
        for widget in self._detail_widgets:
            reload_from_config = getattr(widget, "reload_from_config", None)
    ...
    def _sync_global_sorting_enabled(self) -> None:
        ...
        for field in ROBLOX_COOKIE_CHECKER_MAIN_FIELDS:
            if bool(
                ...
                is_enabled = True
                break
        config.set("Roblox>Cookie Checker>Sorting>Enabled", is_enabled)
    ...
    def __init__(
        ...
        *,
        ...
        if self._sort_kind is not None:
            ...
            modal_host = getattr(self.window(), "_popup_modal_host", None)
            ...
            config.config_loaded.connect(self._sync_sort_button_state)
