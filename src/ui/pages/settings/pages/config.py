...
_CONFIG_DEFAULT_NAME = PATH_DEFAULT_CONFIG.stem
...
class SettingsConfigPage(BasePage):
    ...
    def _build_actions_column(self) -> None:
        ...
        autoload_row = MTSwitchRowSetting(tr_key='ATLD_SLCTD_CFG', obj_name='Config_Autoload')
        layout.addWidget(autoload_row)

        auto_save_row = MTSwitchRowSetting(tr_key='AT_SV_CFG_CHNGS', obj_name='Config_Auto_Save')
    ...
    def _add_info_row(
        ...
        *,
        ...
        value_label = MTPlainLabel(text='-', obj_name=value_obj_name)
    ...
    def _read_autoload_name(self) -> str:
        return str(self._config.loader.get(CLKey.LOADER_CONFIG_ON_LOAD)).strip() or _CONFIG_DEFAULT_NAME

    def _set_autoload_name(self, value: str) -> str:
        normalized = str(value).strip() or _CONFIG_DEFAULT_NAME
    ...
    def _is_default_autoload_locked(selected: str | None, autoload: str) -> bool:
        return selected == _CONFIG_DEFAULT_NAME and autoload == _CONFIG_DEFAULT_NAME
    ...
    def _sync_actions_state(self) -> None:
        ...
        self._autoload_checkbox.setEnabled(has_selection and not is_default_autoload_locked)
        ...
        with QSignalBlocker(self._auto_save_checkbox):
            self._auto_save_checkbox.setChecked(bool(self._config.loader.auto_save_config))
    ...
    def _on_autoload_toggled(self, checked: bool) -> None:
        ...
        if checked:
            ...
            self._set_autoload_name(_CONFIG_DEFAULT_NAME)
